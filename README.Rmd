...
# Step 1b: List of recommended bacteria for quick turnaround
...
The package interfaces with BV-BRC (Bacterial and Viral Bioinformatics Resource Center) 
to access bacterial genome sequences and antimicrobial susceptibility testing data 
either using API/FTP or the BV-BRC CLI in a Docker container for accessibility:
