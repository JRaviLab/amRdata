...
species_counts_for_amreh <- bvbrc_clean |>
  dplyr::distinct(
    species,
...
species_counts_for_amreh <- stats::setNames(
species_counts_for_amreh$genome_count,
species_counts_for_amreh$species
)

save(
species_counts_for_amreh,
file = "data/species_counts_for_amreh.rda"
)

species_for_amreh <- species_counts_for_amreh |>
  dplyr::pull(species)
